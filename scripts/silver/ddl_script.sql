drop table if exists silver.olist_customers_dataset cascade;
...
drop table if exists silver.olist_geolocation_dataset cascade;
...
drop table if exists silver.olist_order_items_dataset cascade;
...
drop table if exists silver.olist_order_payments_dataset cascade;
...
drop table if exists silver.olist_order_reviews_dataset cascade;
...
drop table if exists silver.olist_orders_dataset cascade;
...
drop table if exists silver.olist_products_dataset cascade;
...
drop table if exists silver.olist_sellers_dataset cascade;
